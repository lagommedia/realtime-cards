...
export const TEAM_THEMES: Record<number, TeamTheme> = {
  ...
  140: { // Texas Rangers
    ...
    text: '#FFFFFF', background: '#00091e', cardBackground: '#001030',
  ...
  146: { // Miami Marlins
    ...
    text: '#FFFFFF', background: '#001520', cardBackground: '#002535',
    gradient: 'from-blue-900 to-orange-900', name: 'Miami Marlins',
  },
  121: { // New York Mets
    primary: '#002D72', secondary: '#FF5910', accent: '#FF5910',
    text: '#FFFFFF', background: '#000c20', cardBackground: '#001835',
